...
class KostradRepo {
  KostradRepo._privateConstructor();
  static final KostradRepo instance = KostradRepo._privateConstructor();

  final _kostradShow = Api.kostradShow;

  Future show(Map<String, dynamic> body) async {
    try {
      final response = await http.post(Uri.parse(_kostradShow), body: body);
