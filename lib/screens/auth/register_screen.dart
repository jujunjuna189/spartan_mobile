    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          const Center(child: Text("Daftar Akun", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),)),
          const SizedBox(height: 50,),
          Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  FieldText(controller: _nameController, placeHolder: "Masukan Nama Lengkap...",),
